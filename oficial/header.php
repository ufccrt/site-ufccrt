...
<head>
    ...
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css"
        type="text/css">
    <link rel="stylesheet"
        href="<?php echo home_url( '/' ); ?>wp-content/themes/oficial/css/semantic_ui/semantic.min.css" type="text/css">
    <link rel="stylesheet" href="<?php bloginfo('stylesheet_url');?>">
    <link rel="stylesheet"
        href="<?php echo home_url( '/' ); ?>wp-content/themes/oficial/assertsfont-awesome.min.css/font-awesome/css/font-awesome.min.css"
        type="text/css">
    ...
    <link rel="stylesheet"
        href="<?php echo home_url( '/' ); ?>wp-content/themes/oficial/css/gallery_justify/css/justifiedGallery.min.css"
        type="text/css">
    <link rel="stylesheet" href="<?php echo home_url( '/' ); ?>wp-content/themes/oficial/galery/css/colorbox.css"
        type="text/css">
        ...
        <div class="container">
            <div class="col-md-4 logo-campus">
                <a href="<?php echo site_url();?>" title="<?php bloginfo('name'); ?>">
                    <img class="img-fluid d-block logo_margem"
                        src="http://sistemas.crateus.ufc.br/wordpress/wp-content/themes/ufc-oficial/imgs/logo_ufc_crateus.png"></a>
            </div>
