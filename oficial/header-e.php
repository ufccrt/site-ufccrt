...
<body>
  ...
  <!-- BARRA DE ACESSO A INFORMAÇÃO - GOVERNO FEDERAL -->
  <div id="containerGeral" class="container containerGeral">
    <!-- ***************** HEADER ************* -->
  <div class="row">
  <nav class="navbar navbar-expand-md navbar-light bg-faded">
    ...
    <nav class="navbar navbar-expand-md navbar-light bg-faded text-center novoFundoAlternativo">
       <div class="container layout_centro sombraDivLogo  novoFundoAlternativo2">
        ...
        <button class="navbar-toggler navbar-toggler-center botão-menu-mobile" type="button" data-toggle="collapse" data-target="#navbar2SupportedContent" aria-controls="navbar2SupportedContent" aria-expanded="false" aria-label="Toggle navigation"> <span> MENU PRINCIPAL
      </span> </button>
      <!--menu em colapso-->
